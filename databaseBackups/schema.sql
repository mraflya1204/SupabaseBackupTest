...
CREATE TABLE IF NOT EXISTS "public"."delegation_delegates_old" (
    "id" bigint NOT NULL,
    "delegation_id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "delegate_order" integer NOT NULL,
...
ALTER TABLE "public"."delegation_delegates_old" OWNER TO "postgres";


ALTER TABLE "public"."delegation_delegates_old" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE ONLY "public"."delegation_delegates_old"
...
GRANT ALL ON TABLE "public"."delegation_delegates_old" TO "anon";
GRANT ALL ON TABLE "public"."delegation_delegates_old" TO "authenticated";
GRANT ALL ON TABLE "public"."delegation_delegates_old" TO "service_role";
